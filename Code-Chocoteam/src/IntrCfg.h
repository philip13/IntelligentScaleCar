...
#ifndef INTRCFG_H                               /* To avoid double inclusion */
#define INTRCFG_H
...
#define INTERRUPTS_SET_PRIORITY(Irq_num, priority)					(INTC.PSR[(Irq_num)].R=(priority))
...
#define  	API_INTR				39		// Real Time Counter (RTC/API)
...
extern void IntrCfg_InitAppInterrupts(void);
extern void IntrCfg_PIT0_Interrupt( void );
