...
/****************************************************************************/
    ...
    /************************************/
        ...
        int32_t SIU_reserved7[997];     /* {0x2018-0x1084}/0x4 = 0x3E5 */
        ...
        int32_t SIU_reserved10[280];    /* {0x2500-0x20A0}/0x4 = 0x118 */
        ...
        int32_t SIU_reserved11[692];    /* {0x3000-0x2530}/0x4 = 0x2B4 */
        ...
        int32_t SIU_reserved13[479];    /* {0x3800-0x3084}/0x4 = 0x1DF */
        ...
        int32_t SIU_reserved14[127];    /* {0x3FFC-0x3E00}/0x4 = 0x07F */
...
/****************************************************************************/
    ...
    /************************************/
        /* Register Protection              */
    /************************************/
        int32_t CGM_reserved8[1856];    /* (0x2100 - 0x400)/4 = 0x740 */
        ...
        } CMU_CSR_LOCK;         /* Control Status Register */

        int32_t CGM_reserved9[155];     /* (0x2370 - 0x2104)/4 = 0x9B */
        ...
        } OCEN_LOCK;            /* Output Clock Enable Register */
        ...
        } OCDSSC_LOCK;          /* Output Clock Division Select Register */
        ...
        } SCSS_LOCK;            /* System Clock Select Status */
        ...
        } SCDC_LOCK;            /* GSystem Clock Divider Configuration 0->4 */
        ...
        } AC0SC_LOCK;           /* Aux Clock 0 Select Control */
        ...
        } AC0DC_LOCK;           /* Aux Clock 0 Divider Configuration 0->3 */
        ...
        } AC1SC_LOCK;           /* Aux Clock 1 Select Control */
        ...
        } AC1DC_LOCK;           /* Aux Clock 1 Divider Configuration 0->3 */
        ...
        } AC2SC_LOCK;           /* Aux Clock 2 Select Control */
        ...
        } AC2DC_LOCK;           /* Aux Clock 2 Divider Configuration 0->3 */
        ...
        } AC3SC_LOCK;           /* Aux Clock 3 Select Control */
        ...
        } AC3DC_LOCK;           /* Aux Clock 3 Divider Configuration 0->3 */
        ...
        } AC4SC_LOCK;           /* Aux Clock 4 Select Control */
        ...
        } AC4DC_LOCK;           /* Aux Clock 4 Divider Configuration 0->3 */
        ...
        } AC5SC_LOCK;           /* Aux Clock 5 Select Control */
        ...
        } AC5DC_LOCK;           /* Aux Clock 5 Divider Configuration 0->3 */
        ...
        } AC6SC_LOCK;           /* Aux Clock 6 Select Control */
        ...
        } AC6DC_LOCK;           /* Aux Clock 6 Divider Configuration 0->3 */
        ...
        } AC7SC_LOCK;           /* Aux Clock 7 Select Control */
        ...
        } AC7DC_LOCK;           /* Aux Clock 7 Divider Configuration 0->3 */
        ...
        } AC8SC_LOCK;           /* Aux Clock 8 Select Control */
        ...
        } AC8DC_LOCK;           /* Aux Clock 8 Divider Configuration 0->3 */
        ...
        } AC9SC_LOCK;           /* Aux Clock 9 Select Control */
        ...
        } AC9DC_LOCK;           /* Aux Clock 9 Divider Configuration 0->3 */
        ...
        } AC10SC_LOCK;          /* Aux Clock 10 Select Control */
        ...
        } AC10DC_LOCK;          /* Aux Clock 10 Divider Configuration 0->3 */
        ...
        } AC11SC_LOCK;          /* Aux Clock 11 Select Control */
        ...
        } AC11DC_LOCK;          /* Aux Clock 11 Divider Configuration 0->3 */
        ...
        } AC12SC_LOCK;          /* Aux Clock 12 Select Control */
        ...
        } AC12DC_LOCK;          /* Aux Clock 12 Divider Configuration 0->3 */
        ...
        } AC13SC_LOCK;          /* Aux Clock 13 Select Control */
        ...
        } AC13DC_LOCK;          /* Aux Clock 13 Divider Configuration 0->3 */
        ...
        } AC14SC_LOCK;          /* Aux Clock 14 Select Control */
        ...
        } AC14DC_LOCK;          /* Aux Clock 14 Divider Configuration 0->3 */
        ...
        } AC15SC_LOCK;          /* Aux Clock 15 Select Control */
        ...
        } AC15DC_LOCK;          /* Aux Clock 15 Divider Configuration 0->3 */

        int32_t CGM_reserved10[1280];   /* {0x3800-0x2400}/0x4 = 0x500 */
        ...
        int32_t CGM_reserved11[127];    /* {0x3FFC-0x3E00}/0x4 = 0x07F */
...
/****************************************************************************/
    ...
    /************************************/
        ...
        int16_t RGM_reserved2;  /* 0x1E-0x1F */
        int32_t RGM_reserved3[2040];    /* {0x2000-0x0020}/0x4 = 0x7F8 */
        ...
        } FES_LOCK;             /* Functional Event Status */
        ...
        } DES_LOCK;             /* Destructive Event Status */
        ...
        } FERD_LOCK;            /* Functional Event Reset Disable */
        ...
        } DERD_LOCK;            /* Destructive Event Reset Disable */

        int16_t RGM_reserved4[4];
        ...
        } FEAR_LOCK;            /* Functional Event Alternate Request */
        ...
        } DEAR_LOCK;            /* Destructive Event Alternate Request */

        int16_t RGM_reserved5[2];
        ...
        } FESS_LOCK;            /* Functional Event Short Sequence */
        ...
        union {
            ...
            struct {
                ...
                vuint16_t BOOT:1;
                  vuint16_t:4;
                vuint16_t DRUNDFLA:1;
                  vuint16_t:1;
                vuint16_t DRUNCFLA:1;
            } B;
        } STDBY_LOCK;           /* STANDBY reset sequence */
        ...
        } FBRE_LOCK;            /* Functional Bidirectional Reset Enable */

        int16_t RGM_reserved6;  /* 0x201E-0x201F             */
        int32_t RGM_reserved7[1528];    /* {3800-0x2020}/0x4 = 0x5F8 */
        ...
        int32_t RGM_reserved8[127];     /* {0x3FFC-0x3E00}/0x4 = 0x07F */
...
/****************************************************************************/
    ...
    /************************************/
        ...
        int32_t PCU_reserved1[2015];    /* {0x2000-0x0084}/0x4 = 0x7DF */
        ...
        } PCONF_LOCK[16];       /* Power domain 0-15 configuration register */
        ...
        } PSTAT_LOCK;           /* Power Domain Status Register */

        int32_t PCU_reserved2[1519];    /* {0x3800-0x2044}/0x4 = 0x5EF */
        ...
        int32_t PCU_reserved3[127];     /* {0x3FFC-0x3E00}/0x4 = 0x07F */
    ...
    struct FLEXPWM_SUB_tag {
        ...
        union {
            ...
            struct {
                ...
                vuint16_t WAITEN:1;
                vuint16_t INDEP:1;
                vuint16_t PWM23INIT:1;
                vuint16_t PWM45INIT:1;
                vuint16_t PWMXINIT:1;
                vuint16_t INITSEL:2;
                vuint16_t FRCEN:1;
                vuint16_t FORCE:1;
                vuint16_t FORCESEL:3;
                vuint16_t RELOADSEL:1;
                vuint16_t CLKSEL:2;
            } B;
        ...
        } DCNT1;                /* Deadtime Count Register 1 */
...
#define SRAM_END      0x40007FFFUL

/* 512kB CODE FLASH */
#define CFLASH_START         0x0UL
#define CFLASH_SIZE      0x80000UL
#define CFLASH_END       0x7FFFFUL

/* 64kB DATA FLASH */
#define DFLASH_START    0x800000UL
#define DFLASH_SIZE      0x10000UL
#define DFLASH_END      0x80FFFFUL
